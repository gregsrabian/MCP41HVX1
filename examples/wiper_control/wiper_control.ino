/*
  wiper_control.ino - Example for controlling the MCP41HVX1 family of digital potentiometers. This example demonstraits how to control the wiper position.
...
This sketch demonstrates creating an instance of the MCP41HVX1 class and using the WiperSetPosition(), WiperIncrement(), WiperDecrement(), and WiperGetPosition() methods.
...
void loop ()
{
    ...
    int   nWiper = Digipot.WiperGetPosition();  // Get the current wiper postion from the digipot
